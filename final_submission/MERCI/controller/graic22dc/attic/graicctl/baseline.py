...
try:
    ...
    print("skipping ros modules")
import numpy as np
import yaml
import json
<<<<<<< HEAD:attic/graicctl/baseline.py
from graicctl.common import VehicleDecisionBase
=======
from graic22dc.src.planner.common import VehicleDecisionBase
>>>>>>> feature/tuning:src/planner/baseline.py
...
class BaselineVehicleDecision(VehicleDecisionBase):
    def __init__(self):
...
<<<<<<< HEAD:attic/graicctl/baseline.py
class BaselineVehicleController:
=======
class BaselineVehicleController():
>>>>>>> feature/tuning:src/planner/baseline.py
    def stop(self):
        ...
        newAckermannCmd.acceleration = -100
        newAckermannCmd.jerk = -100
        newAckermannCmd.speed = 5
